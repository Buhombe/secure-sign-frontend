...
export default function PlaceFields() {
  ...
  return (
    <AppShell>
      <style>{`
        .pf-layout { display: flex; flex-direction: row; background: #e2e8f0; flex: 1; min-height: 0; overflow: hidden; }
        .pf-sidebar { width: 280px; min-width: 260px; max-width: 320px; flex-shrink: 0; background: white; border-right: 1px solid #e2e8f0; display: flex; flex-direction: column; overflow-y: auto; }
        .pf-main { flex: 1; overflow: auto; padding: 1.5rem; }
        @media (max-width: 767px) {
          .pf-layout  { flex-direction: column; overflow: auto; height: auto; }
          .pf-sidebar { width: 100% !important; max-width: 100% !important; min-width: unset !important; border-right: none !important; border-bottom: 1px solid #e2e8f0; overflow-y: visible; }
          .pf-main    { padding: 0.75rem; overflow: visible; }
        }
      `}</style>
...
const s = {
  ...
  sidebar: { width: 280, minWidth: 260, maxWidth: 320, flexShrink: 0, background: 'white', borderRight: '1px solid #e2e8f0', display: 'flex', flexDirection: 'column', overflowY: 'auto', height: '100%' },
