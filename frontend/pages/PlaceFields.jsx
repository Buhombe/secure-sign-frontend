...
export default function PlaceFields() {
  ...
  return (
    <AppShell>
      <div style={{ flex: 1, display: 'flex', flexDirection: window.innerWidth < 768 ? 'column' : 'row', background: '#e2e8f0', minHeight: 0 }}>
...
const s = {
  ...
  sidebar: { width: '100%', maxWidth: '100%', flexShrink: 0, background: 'white', borderBottom: '1px solid #e2e8f0', borderRight: 'none', display: 'flex', flexDirection: 'column', overflow: 'visible' },
