    ...
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);max-width:600px;">
          <!-- Top accent bar -->
          <tr>
            <td style="background:linear-gradient(135deg,#1a56b0 0%,#1e40af 100%);padding:0;height:5px;"></td>
          </tr>
          <!-- Header -->
          <tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td>
                    ...
                    <p style="margin:4px 0 0;font-size:12px;color:#64748b;letter-spacing:0.5px;text-transform:uppercase;">
                      Secure Electronic Signatures
                    </p>
                  </td>
                  <td align="right">
                    <span style="display:inline-block;padding:4px 12px;background:#eff6ff;color:#1d4ed8;font-size:11px;font-weight:600;border-radius:20px;border:1px solid #bfdbfe;">
                      Action Required
                    </span>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    <p style="margin:0;color:#475569;font-size:12px;line-height:1.6;">
                      ...
                      This signing link is unique to you and encrypted end-to-end.
...
async function sendSigningEmail(recipientEmail, signingLink, documentName = 'a document') {
  ...
  const html = wrapHtml(subject, `
    <p style="margin:0 0 8px;color:#64748b;font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;">
      Signature Requested
    </p>
    <h1 style="margin:0 0 20px;color:#0f172a;font-size:26px;font-weight:800;line-height:1.2;">
      You have a document<br>ready to sign
    </h1>
    ...
    <p style="margin:0 0 32px;color:#475569;font-size:15px;line-height:1.7;">
      Someone has requested your electronic signature on the document above.
      Click the button below to review and sign it securely.
    ...
    <table cellpadding="0" cellspacing="0" style="margin:0 0 32px;">
      <tr>
        <td style="border-radius:10px;background:#1a56b0;box-shadow:0 4px 16px rgba(26,86,176,0.35);">
          <a href="${signingLink}"
             style="display:inline-block;padding:18px 48px;color:#ffffff;
                    font-size:16px;font-weight:700;text-decoration:none;border-radius:10px;letter-spacing:-0.2px;">
